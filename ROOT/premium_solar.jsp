...
<head>
  ...
  <title>California Solar Group - A to Z Solar Installation Service</title>
  ...
  <main id="main">
    ...
    <section class="breadcrumbs">
     ...
     <section id="services" class="services">
       <div class="container">
         <h1>Welcome to California Solar Group</h1>
         <h2>Your Premium Battery Installer</h2>
         <div class="card">
             <div class="card-body">
                 <h3 class="card-title">Unparalleled Expertise</h3>
