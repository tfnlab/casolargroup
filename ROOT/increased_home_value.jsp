...
<body>
  ...
  <main id="main">
    ...
    <section class="inner-page">
      <div class="container">
        <h1>How Solar Installations Can Add up to 4% Increase to Home Value</h1>
        ...
        <p>Research has shown that solar installations can increase the value of a home by up to 4%. This
